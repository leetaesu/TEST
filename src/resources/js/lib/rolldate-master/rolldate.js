...
(function (global, factory) {
  ...
  Rolldate.prototype = {
    ...
    createUI: function createUI() {
      ...
      var $html = 
      '<div class="rolldate-mask"></div>\n<div class="rolldate-panel" style="border-radius: 2rem 2rem 0 0;height:330px;min-height:6.8rem;">\n<header style="line-height:1;">\n'  
      + '<span style="position: absolute;top: 0.7rem;left: calc(50% - 2.2rem);width: 4.4rem;height: 0.3rem;background-color: var(--c-gray-400);border-radius: 0.2rem;"></span>'
      + '<span style="font-size: 2rem; line-height: 6.8rem; font-weight: 700;">' + lang.title + '</span>' + 
        '<span class="rolldate-cancel" style="position:absolute;left:auto;right:0;width:50px;height:50px;padding-top:23px;">\n'
        + '<img src="../../../resources/new_images/icons/ico_close_s.svg" style="width:14px;height:14px;">'
        + '</span>\n' + 
        '</header>\n<section class="rolldate-content">\n<div class="rolldate-dim mask-top"></div><div class="blind-top" style="position:absolute;width:100%;background:#fff;z-index:999;">&nbsp;</div>\n<div class="rolldate-dim mask-bottom"></div><div class="blind-bottom" style="position:absolute;bottom:0;width:100%;background:#fff;z-index:999;">&nbsp;</div>\n<div class="rolldate-wrapper" style="">\n'
        + ul + 
        '\n</div>\n</section>\n'        
        + '<footer style="margin-top:40px;background:#181949">\n' + 
        '<span class="rolldate-btn rolldate-confirm" style="position:static; display:flex;justify-content: center; align-items: center; width:100%; line-height:56px;color:#fff; font-size:1.8rem; font-weight: 500;">'
        + lang.confirm +  
        '</span>\n'
        + '</footer>\n' + 
        '</div>',
